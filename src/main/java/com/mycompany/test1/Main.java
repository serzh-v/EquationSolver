...
/**
 * на случай если значение перовго коэффициента уравнения равно нулю
 * во избежании ошибки с делением на ноль и бессмысленных значений корней
 * используем exception и в этом случае объявляем, что уравнение не квадратное 
 * @author Dell
 */
public class Main {
